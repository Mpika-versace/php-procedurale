...
<head>
    ...
    <meta name="author" content="versace Mpika, Jacob Thornton, and Bootstrap contributors">
    <title>
      <?php 
          $title=isset($title)?  $title:'Mon site';
          echo $title;
      ?>
    </title>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">PHP Courses</a>
